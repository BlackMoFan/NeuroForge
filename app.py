...
def get_inputknn():
    ...
    knnexperience = 5
    knnsalary = 70000
    knnpredicted = "Software Engineer"

    return render_template(
        'activity1knn.html',
        knnexperience=knnexperience,
        knnsalary=knnsalary,
        knnprediction=knnpredicted,
        demo_message="This is for demo only and does not actually run the models."
    )
#--------------- KNN PART
...
def get_inputkmeans():
    ...
    # Hardcoded values for demo
    kmeansNumCluster = 3
    kmeansimg = None  # Replace with a placeholder image if needed

    return render_template(
        'activity2kmeans.html',
        kmeansimg=kmeansimg,
        demo_message="This is for demo only and does not actually run the models."
    )
...
def get_inputNB():
    ...
    # Hardcoded values for demo
    nbPredictedWord = "Data Scientist"
    nbExp = 3
    nbSalary = 80000

    return render_template(
        'activity3nbayes.html',
        nbimg=None,
        nbPredictedWord=nbPredictedWord,
        nbExp=nbExp,
        nbSalary=nbSalary,
        demo_message="This is for demo only and does not actually run the models."
    )
...
def get_inputReg():
    ...
    return render_template(
        'activity4regression.html',
        regPrediction=regPrediction,
        regJob=regJob,
...
def get_inputTextGen():
    ...
    # Hardcoded values for demo
    generated_text = "This is a generated text example for demo purposes."
    genType = "GRU"
    num_words = 10

    return render_template(
        'activity5textgen.html',
        textgenResult=generated_text,
        genType=genType,
        num_words=num_words,
        demo_message="This is for demo only and does not actually run the models."
    )
...
def get_inputClassification():
    ...
    # Hardcoded values for demo
    review = "This is a sample review for demo purposes."
    predicted_labels = "Positive"

    return render_template(
        'activity6classification.html',
        review=review,
